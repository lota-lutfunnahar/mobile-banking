...
@Entity
@Table(name = "customer")
public class MobileRechargeCustomerEntity {
    ...
    @JoinTable(name = "customeraccount",
            joinColumns = @JoinColumn(name = "customeroid", referencedColumnName = "customeroid"),
            inverseJoinColumns = @JoinColumn(name = "accountoid", referencedColumnName = "accountoid")
    )
    private Set<MobileRechargeAccountEntity> accounts;


    @JsonBackReference
    @ManyToOne(cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch = FetchType.LAZY)
    @JoinColumn(name = "ibconsumeroid", referencedColumnName="ibconsumeroid")
    private MobileRechargeIbConsumerEntity ibconsumer;


    @JsonBackReference
    @ManyToMany(mappedBy = "customers")
    Set<MobileRechargeSelfAccountCreationPersonEntity> persons;
